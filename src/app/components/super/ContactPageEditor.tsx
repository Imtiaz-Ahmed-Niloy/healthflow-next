...
import { defaultContactContent, useContactContent, type ContactContent, type ContactChannel } from "@/data/cmsContact";
...
const ContactPageEditor = () => {
  ...
  const onReset = () => { reset(); setDraft(defaultContactContent); setDirty(false); toast.success("Contact page reset"); };
