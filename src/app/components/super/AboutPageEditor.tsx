...
import { defaultAboutContent, useAboutContent, type AboutContent, type Pillar, type TeamMember, type Stat, type JourneyStep, type CoreObjective } from "@/data/cmsAbout";
...
const AboutPageEditor = () => {
  ...
  const onReset = () => { reset(); setDraft(defaultAboutContent); setDirty(false); toast.success("About page reset"); };
