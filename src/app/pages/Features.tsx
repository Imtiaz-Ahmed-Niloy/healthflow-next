...
import n1 from "@/assets/medical-1.jpg";
import n2 from "@/assets/medical-2.jpg";
import n3 from "@/assets/medical-3.jpg";
import n4 from "@/assets/medical-4.jpg";
        ...
        <section className="container mx-auto pt-12 pb-16">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, delay: 0.2 }} className="relative">
              <img src={dashboard.src} alt="HealthFlow precision dashboard" width={1280} height={1024} className="rounded-2xl shadow-card w-full object-cover aspect-[4/3]" />
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
            <div className="grid grid-cols-2 gap-4">
              {[n1, n2, n3, n4].map((src, i) => (
                <motion.img key={i} src={src.src} alt="" width={800} height={800} loading="lazy"
