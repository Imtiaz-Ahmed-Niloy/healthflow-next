          ...
          <section className="container mx-auto py-10 grid lg:grid-cols-12 gap-8 border-b border-border/60">
            ...
            >
              ...
              <div className="mt-5 overflow-hidden rounded-2xl border border-border/60">
                <img src={imageSrc(lead.cover)} alt={lead.title} className="w-full h-[340px] object-cover transition-transform duration-700 group-hover:scale-[1.02]" loading="lazy" />
              </div>
              <div className="mt-4 flex items-center gap-3 text-xs text-muted-foreground">
                <img src={imageSrc(lead.authorPhoto)} alt={lead.author} className="h-8 w-8 rounded-full object-cover" loading="lazy" />
              ...
              {filtered.map((p, i) => (
                ...
                >
                  ...
                  <div className="mt-4 pt-4 border-t border-border/60 flex items-center gap-3">
                    <img src={imageSrc(p.authorPhoto)} alt={p.author} className="h-9 w-9 rounded-full object-cover" loading="lazy" />
