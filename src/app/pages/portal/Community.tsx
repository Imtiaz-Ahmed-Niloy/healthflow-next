...
const doctorAvatarSrc = doctorAvatar.src;
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="rounded-2xl bg-card border border-border/60 p-5 shadow-soft">
          <div className="flex gap-3">
            <img src={doctorAvatarSrc} alt="me" className="h-10 w-10 rounded-full object-cover" />
              ...
              {(openComments[p.id] || p.comments.length > 0) && (
                <div className="bg-chip/30 border-t border-border/40 px-5 py-4 space-y-3">
                  ...
                  <div className="flex gap-3 pt-1">
                    <img src={doctorAvatarSrc} alt="me" className="h-8 w-8 rounded-full object-cover flex-shrink-0" />
