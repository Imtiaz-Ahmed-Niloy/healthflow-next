...
import {
  ...
  ClipboardList, ShieldCheck, Landmark, Pill, Settings, LogOut, Bell, Menu, X,
  Truck, UserPlus, CalendarDays, BellRing,
} from "lucide-react";
...
export const adminNav = [
  ...
  { to: "/admin/finance", icon: Landmark, label: "Finance", group: "Business" },
      ...
      <header className="bg-card border-b border-border/50 sticky top-0 z-30">
        <div className="flex items-center justify-between gap-4 px-4 lg:px-8 py-4">
          ...
          <div className="flex items-center gap-3 lg:gap-5">
            ...
            <button onClick={() => { clearSession(); toast.success("Signed out"); navigate("/signin"); }}
