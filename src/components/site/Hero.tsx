      ...
      <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        ...
        >
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link to="/patient/find-doctors" className="group inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3.5 text-sm font-semibold text-primary-foreground hover:bg-primary-glow transition-all hover:shadow-card">
              {content.heroBookCta}
              <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
            </Link>
            <Link to="/hospitals" className="inline-flex items-center rounded-full border border-border bg-card px-6 py-3.5 text-sm font-semibold text-primary hover:bg-muted transition-colors">
