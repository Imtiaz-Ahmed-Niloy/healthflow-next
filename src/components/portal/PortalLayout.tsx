...
import { LayoutGrid, Users, BookUser, Calendar, LogOut, Bell, Settings, BookOpen, MessagesSquare, UserRound, Store } from "lucide-react";
...
const links = [
  ...
  { to: "/portal/chambers", icon: Store, label: "My Chambers" },
